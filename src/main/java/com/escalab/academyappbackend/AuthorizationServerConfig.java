...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
	...
	@Autowired
	private JwtAccessTokenConverter accessTokenConverter;//Access para convertir un token
	
	@Autowired
	private AuthenticationManager authenticationManager;
	
	@Autowired
	private BCryptPasswordEncoder bcrypt;//compara la contraseña pero no la genera
